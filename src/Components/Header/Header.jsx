    ...
    <header className="px-5 py-4 w-full">
      <div className="max-w-screen-2xl flex justify-between items-center">
        <div className="flex gap-16 items-center">
          <div className="flex gap-2 items-center fill-white cursor-pointer hover:text-violet-700 hover:fill-violet-700 duration-300">
            <svg
              className="w-8"
              version="1.1"
            ...
            <h1 className="font-semibold text-lg">Game Shop</h1>
          </div>
